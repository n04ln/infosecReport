...
/* package rsa-report-0.1.0.0 */
#define VERSION_rsa_report "0.1.0.0"
#define MIN_VERSION_rsa_report(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "rsa-report-0.1.0.0-5iswHUjlzUzCMH0rDQAKao"

#define CURRENT_PACKAGE_KEY "rsa-report-0.1.0.0-5iswHUjlzUzCMH0rDQAKao"
